...
from .layers.bert.config import add_bert_parser
import argparse
...
def get_bert_model(args):
    ...
    update_params = ['img_feature_dim', 'num_hidden_layers', 'hidden_size', 'num_attention_heads', 'intermediate_size', 'vocab_size']
