...
from evaluation.eval import evaluate_inference
...
if __name__ == "__main__":
    ...
    # test
    trainer.test(
        model, qvh_data, ckpt_path=configs.lightning.load_ckpt_path
    )  # this should be commented during evaluation

    # evaluation
    # evaluate_inference(
    #     eval_cfg=eval_cfg, mode=mode
    # )  # this line should be commented during inference
